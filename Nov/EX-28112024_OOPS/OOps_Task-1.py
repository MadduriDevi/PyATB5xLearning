...
student_information1 = PyATB ("Devi", "Python", "Morning","3 Months", "KA" )
student_information2 = PyATB("pink", "API", "Afternoon","1 Months", "HYD" )
student_information3 = PyATB("blue", "Automation", "Evening","2 Months", "CH" )
